...
This repository contains data and analysis concerning study titled "Sweetness is in the Ear of the Beholder: Chord Preference Across Western and Pakistani Listeners" by Imre Lahdelma, George Athanasopoulos, and Tuomas Eerola. These files are available at [https://github.com/tuomaseerola/pakistan-chords/](https://github.com/tuomaseerola/pakistan-chords/).
